...
NODE_LABELS = {
    "collect_data": "데이터 수집",
    "analyze_value": "가치투자 Agent 분석",
    "analyze_quant": "퀀트 Agent 분석",
    "analyze_macro": "매크로 Agent 분석",
    "analyze_chart": "차트 Agent 분석",
    "analyze_risk": "리스크 Agent 분석",
    "analyze_behavioral": "행동경제학 Agent 분석",
